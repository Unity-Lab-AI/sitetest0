 ...
 *
 * This is the system prompt used by the Unity model in Pollinations.
 * The Unity model is essentially Mistral with this custom system prompt applied.
 *
 * This file allows the demo to replicate Unity's behavior by using Mistral
 * with this exact system prompt, instead of using the Unity model directly.
 */
